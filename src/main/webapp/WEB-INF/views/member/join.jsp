									...
									<form:form method="post" modelAttribute="memberDTO"
										...
										<div class="form-group">
											...
											<div id="usernameResult"
												style="font-size: 0.8rem; margin-top: 5px;"></div>
										...
										<!-- 비밀번호 확인 (DTO에 필드가 없다면 path 대신 일반 input 사용) -->
										<div class="form-group">
											<label for="passwordCheck" class="font-weight-bold">비밀번호
												확인</label>
											<form:password path="passwordCheck" cssClass="form-control"
												id="passwordCheck" placeholder="비밀번호를 다시 입력하세요"
												 />
										...
										<div class="text-right">
											...
											<button type="submit" id="joinBtn"
												class="btn btn-primary px-4">가입하기</button>
										</div>
