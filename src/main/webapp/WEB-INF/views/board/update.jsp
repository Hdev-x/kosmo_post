									...
									<form action="./update" method="post"
										...
										<div class="form-group">
											<label>첨부파일</label> <input type="file" name="attach"
												...
												name="attach" class="form-control">
										</div>
